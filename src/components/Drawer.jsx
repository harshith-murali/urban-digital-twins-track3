      ...
      items: [
        {
          ...
          label: "Traffic",
          icon: Activity,
          badge: criticalCount > 0 ? "LIVE" : null,
          badgeType: "red",
        },
        {
          id: "energy",
          ...
          >
            {DRAWER_ITEMS.map(({ section, items }) => (
              <div key={section}>
                ...
                <div
                  style={{ height: "0.5px", background: bdr, margin: "6px 0" }}
                />
              </div>
            ))}
              ...
              {healthData.map((h) => (
                <div key={h.label} style={{ marginBottom: 8 }}>
                  ...
                  >
                    ...
                    <span style={{ color: txt, fontFamily: fontMono }}>
                      {h.val}%
                    </span>
                  </div>
